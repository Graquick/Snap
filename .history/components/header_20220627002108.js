...
function Header() {
  ...
  const [open, setEnabled] = useState(false)
            ...
            <div className="w-[70%]">
              ...
              <li className="flex items-center cursor-pointer text-gray-500 font-semibold justify-between w-[20%] hover:text-black transition-all ease-in-out duration-300 relative">
                <Menu>
                  {( {open} ) => (
                    <>
                      <Menu.Button className="flex items-center justify-center gap-4" >Features <Icon icon="akar-icons:chevron-down" /></Menu.Button>  
                    </>
                  )}
                </Menu>
              </li>
