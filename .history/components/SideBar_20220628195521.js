  ...
  return (
    <>  
        ...
        <AnimatePresence>
            ...
            <motion.div className="bg-neutral-100/80 backdrop-blur-sm h-[820px] w-[90%] absolute top-0 -right-12  z-10 flex flex-col justify-center items-center text-white dark:bg-neutral-800/80 dark:"
                initial={false}
