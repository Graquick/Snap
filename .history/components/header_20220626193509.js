              ...
              <li className="flex items-center cursor-pointer text-gray-500 font-semibold justify-between w-[20%] hover:text-black transition-all ease-in-out duration-300 relative">
                  <Menu>
                    ...
                    <Menu.Items className="absolute right-16 z-10 bg-white border border-red-100">
                      <Menu.Item><a href="#" className="block px-5 py-0">Todo List</a></Menu.Item>
                      <Menu.Item><a href="#" className="block px-5 py-0">Calendar</a></Menu.Item>
                      <Menu.Item><a href="#" className="block px-5 py-0">Reminders</a></Menu.Item>
                      <Menu.Item><a href="#" className="block px-5 py-0">Planning</a></Menu.Item>
                    </Menu.Items>
                  </Menu>
              </li>
