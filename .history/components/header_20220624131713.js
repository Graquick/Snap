...
function Header() {
  return (
    <>
      <header className="flex max-w-[80%] m-auto bg-red-100 justify-between sticky top-0">
        <div className="flex w-[45%] bg-red-400 justify-between items-center">
            ...
            <div className="w-[70%]">
              <ul className="flex w-full justify-between text-xl">
                <li className="flex items-center cursor-pointer justify-between w-[17%]">Features <motion.div
                  whileTap={{ rotate: 180 }}
                ><Icon icon="akar-icons:chevron-down" /></motion.div></li>
                <li className="flex items-center cursor-pointer justify-between w-[19%]">Company <motion.div
                  whileTap={{ rotate: 180 }}
                ><Icon icon="akar-icons:chevron-down" /></motion.div></li>
                <li className="flex items-center cursor-pointer text-gray-500 font-medium justify-center w-fit">Careers</li>
                <li className="flex items-center cursor-pointer text-gray-500 font-medium justify-center w-fit">About</li>
              </ul>
            </div>
        </div>
