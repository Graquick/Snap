        ...
        <AnimatePresence>
            ...
            >
                <ul className="absolute top-32 left-0 flex flex-col gap-8 items-center w-[250px] h-[650px] text-xl">
                            ...
                            <li className="flex items-center justify-center font-semibold text-gray-500 transition-all duration-300 ease-in-out cursor-pointer w-fit dark:text-violet-">About</li>
                </ul>
            </motion.div>
        </AnimatePresence>
    </>
