            ...
            <div className="w-[70%]">
              <ul className="flex w-full justify-between text-xl">
                ...
                <li className="flex items-center cursor-pointer justify-between w-[19%]">Company <motion.div
                  whileTap={{ rotate: 180 }}
                ><Icon icon="akar-icons:chevron-down" /></motion.div></li>
                <li className="flex items-center cursor-pointer text-gray-500 justify-center w-fit">Careers</li>
                <li className="flex items-center cursor-pointer text-gray-500 justify-center w-fit">About</li>
              </ul>
            </div>
        </div>
