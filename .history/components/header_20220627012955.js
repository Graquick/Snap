                  ...
                  <Menu>
                    {({open}) => (
                      <>
                        ...
                        {open && (
                          <>
                            <Menu.Items className="absolute left-0 z-10 h-56 bg-white border rounded-md focus:outline-none w-44 top-12 dark:border-neutral-500"
                              static
                              as={motion.div}
                              initial={{ scale: 0, x: 10, y: 10, skew: 0 }}
                              animate={{ scale: 1, x: 10, y: 10, skew: 1 }}
                              transition={spring}
