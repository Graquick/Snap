  ...
  return mounted && (
    <>
      <header className="flex max-w-[1600px] w-[95%] m-auto justify-between sticky top-0 h-36 items-center 2xl:w-[375px]">
        ...
        {/* // Mobile */}
        <div className="font-[Arial, Helvetica, sans-serif] text-5 font-bold text-black cursor-default transition-all w-fit duration-150 ease-in-out relative group dark:text-white">  <svg
              className="absolute top-[2.5rem] -right-8 w-[26px] h-[26px] transition-all duration-500 ease-in-out"
              width={26}
              height={24}
              viewBox="0 0 26 24"
