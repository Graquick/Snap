                                ...
                                >
                                  <Menu.Item as={motion.div} whileHover={{ scale: 1.1 }} whileTap={{ scale: .9}} transition={spring}>
                                      {({ active }) => (
                                        ...
                                        >
                                          <Icon icon="uil:clipboard-notes" className="text-xl xl:text-" /> Features
                                        </MyLink>
                                      )}
                                  </Menu.Item>
                                  ...
                                  <Menu.Item as={motion.div} whileHover={{ scale: 1.1 }} whileTap={{ scale: .9}} transition={spring}>
                                      {({ active }) => (
                                        ...
                                        >
                                          <Icon icon="uil:calendar-alt" className="text-xl xl:text-" /> Calendar
                                        </MyLink>
                                      )}
                                  </Menu.Item>
                                  ...
                                  <Menu.Item as={motion.div} whileHover={{ scale: 1.1 }} whileTap={{ scale: .9}} transition={spring}>
                                      {({ active }) => (
                                        ...
                                        >
                                          <Icon icon="uil:lightbulb-alt" className="text-xl xl:text-" /> Reminders
                                        </MyLink>
                                      )}
                                  </Menu.Item>
