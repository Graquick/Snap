    ...
    <>  
        ...
        <AnimatePresence>
            ...
            <motion.div className="bg-neutral-100/80 backdrop-blur-sm h-[850px] w-[90%] absolute top-0 -right-12  z-10 flex flex-col justify-center items-center text-black dark:bg-neutral-800/80 dark:text-white"
                ...
                exit="closed"
            >
                <ul className="absolute top-[2.75rem] left-0 flex flex-col gap-8 items-start text-left w-[250px] h-[650px] text-xl pl-12">
                ...
                <div className="absolute bottom-0 left-16 flex flex-col items-center justify-center gap-4">
