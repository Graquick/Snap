        ...
        <AnimatePresence>
            ...
            >
                ...
                <div className="absolute bottom-16 left-16 flex flex-col items-center justify-center gap-2">
                    <motion.div className="cursor-pointer w-[170px] h-[45px] font-epilogue text-[18px] font-semibold no-underline flex items-center justify-center text-center text-black dark:text-white"
