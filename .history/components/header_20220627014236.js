                  ...
                  <Menu>
                    {({open}) => (
                      <>
                        ...
                        {open && (
                          <>
                            <Menu.Items static className={`${open ? 'hidden' :'block'}`}
                              styles={{ position: "absolute", top: "3rem", left: 0, zIndex: 10, width: "11rem", height: "14rem", background: "white", border: "solid 1px white" }}
