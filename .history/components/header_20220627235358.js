...
function Header() {
  ...
  return mounted && (
    <>
      <header className="flex max-w-[1600px] w-[95%] m-auto justify-between sticky top-0 h-36 items-center 2xl:w-[375px] bg-yellow-300 2xl:h-16">
        ...
        <div className="w-16 h-16 bg-red-200 flex items-center justify-center z-40 absolute">
          <Example />
        </div>
