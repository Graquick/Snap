                      ...
                      <>
                        ...
                        <AnimatePresence ExitBeforeEnter>
                            {enabled && (
                              <>
                                <Menu.Items static 
                                  className="absolute left-0 z-10 flex flex-col justify-center bg-white text-black h-[13.25rem] focus:outline-none w-44 top-12 dark:border-neutral-500 2xl:w-36 2xl:h-44 2xl:gap-2 xl:w-24"
                                  as={motion.div}
                                  initial={{ y: 100}}
                                  animate={{ y: 0}}
                                  ...
                                  <Menu.Item as={motion.div} whileHover={{ scale: 1.1 }} whileTap={{ scale: .9}} transition={spring}>
                                      {({ active }) => (
                                        <MyLink href="#"
                                          className={`${
                                            active ? 'bg-neutral-200 dark:bg-neutral-500' : 'dark:text-black'
                                          } whitespace-nowrap py-3 px-5 flex gap-3 justify-start items-center w-full  2xl:text-[1.1rem] 2xl:h-4 2xl:gap-2 2xl:py-0 2xl:px-4  xl:text-[.7rem]`}
                                        >
