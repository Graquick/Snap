        ...
        <div className="flex w-[850px] justify-between items-center 2xl:w-[750px] xl:w-[550px]">
            ...
            <div className="w-[600px] 2xl:w-[500px] xl:w-[300px] ">
              <ul className="flex justify-between w-full text-xl 2xl:text-[1rem] xl:text-[.75rem]">
                ...
                <li className="flex items-center cursor-pointer text-gray-500 font-semibold justify-between w-[20%] transition-all ease-in-out duration-300 relative dark:text-white 2xl:w-[15%] xl:w-">
                  <Menu>
                    {({open}) => (
                      <>
