        ...
        <AnimatePresence>
            ...
            >
                <ul className="absolute top-32 left-0 flex flex-col gap-8 items-center w-[250px] h-[650px] text-xl">
                            <li className="flex flex-col items-center cursor-pointer text-gray-500 font-semibold justify-between w-[20%] transition-all ease-in-out duration-300 relative dark:text-purple-400 dark:hover:bg">
                            <Menu>
                                {({open}) => (
                                <>
