...
function Header() {
  ...
  return mounted && (
    <>
      <header className="flex max-w-[1200px] mx-auto justify-between sticky top-0 z-10  bg-neutral-100 h-32 items-center dark:bg-neutral-800 2xl:w-[375px] 2xl:h-16">
