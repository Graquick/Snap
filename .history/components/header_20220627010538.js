        ...
        <div className="flex w-[45%] justify-between items-center">
            ...
            <div className="w-[70%]">
              <ul className="flex justify-between w-full text-xl">
                ...
                <li>
                  <motion.div className="flex items-center cursor-pointer text-gray-500 font-semibold justify-between w-[20%] transition-all ease-in-out duration-300 relative dark:text-white"
                    ...
                    <Menu>
                      {({open}) => (
                        <>
                          ...
                          {open && (
                            <>
                              <Menu.Items className="absolute left-0 z-10 w-40 bg-white border rounded-md top-12 h-44 dark:border-neutral-500">
                                <Menu.Item>
                                    {({ active }) => (
                                      <MyLink href="#"
                                        className={`${
