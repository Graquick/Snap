                  ...
                  <Menu>
                    {({open}) => (
                      <>
                        ...
                        {open && (
                          <>
                            <Menu.Items className="absolute left-0 z-10 flex flex-col items-start h-56 bg-white border rounded-md w-44 top-12 dark:border-neutral-500" static>
                              <Menu.Item>
                                  {({ active }) => (
                                    <MyLink href="#"
                                      className={`${
                                      ...
                                      style={{ whiteSpace: "nowrap", padding: " .75rem 1.25rem", display: "flex", gap: ".75rem", justifyContent: "center", alignItems: "center", width: "100%" }}
                                    >
                              ...
                              <Menu.Item>
                                  {({ active }) => (
                                    <MyLink href="#"
                                      ...
                                      style={{ whiteSpace: "nowrap", padding: " .75rem 1.25rem", display: "flex", gap: ".75rem", justifyContent: "center", alignItems: "center"  }}
                                    >
                                      <Icon icon="uil:clipboard-notes" /> Reminders
                                    </MyLink>
                                  )}
                              </Menu.Item>
                              ...
                              <Menu.Item>
                                  {({ active }) => (
                                    <MyLink href="#"
                                      ...
                                      style={{ whiteSpace: "nowrap", padding: " .75rem 1.25rem", display: "flex", gap: ".75rem", justifyContent: "center", alignItems: "center"  }}
                                    >
                                      <Icon icon="uil:clipboard-notes" /> Planning
                                    </MyLink>
                                  )}
                              </Menu.Item>
                            </Menu.Items> 
