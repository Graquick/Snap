...
function SideBar() {
  return (
    <>
        ...
        <div className="p6 w-1/2 h-screen bg-neutral-100 z-10 top-0 -left-96 lg:w-60 transition-all">
            <div className="flex flex-col justify-start items-center">
                <h1 className="text-base text-center cursor-pointer font-bold text-blue-900 border-b borgra100"></h1>
            </div>
