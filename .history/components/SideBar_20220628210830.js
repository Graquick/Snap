            ...
            >
                <ul className="absolute top-24 left-0 flex flex-col gap-8 items-start text-left w-[250px] h-[650px] text-xl pl-12">
                            ...
                            <Menu>
                                {({open}) => (
                                <>
                                    <Switch checked={enabled} onChange={setEnabled} className={`${enabled ? 'text-dark:text-yellow-400' : 'text-black dark:text-white'} flex items-center justify-start gap-4`}>
