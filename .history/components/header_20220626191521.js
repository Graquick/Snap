        ...
        <div className="flex w-[45%] justify-between items-center">
            ...
            <div className="w-[70%]">
              <ul className="flex w-full justify-between text-xl">
                ...
                <Menu>
                  <Menu.Button>
                      <li className="flex items-center cursor-pointer text-gray-500 font-semibold justify-between w-[20%] bg-red- hover:text-black transition-all ease-in-out duration-300">Features <motion.div
                      whileTap={{ rotate: 180 }}
