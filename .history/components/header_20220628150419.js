  ...
  return mounted && (
    <>
      <header className="flex w-full mx-auto justify-between sticky top-0 z-10  bg-neutral-100 h-32 items-center dark:bg-neutral-80 bg-amber-400">
        <div className="flex w-[850px] justify-between items-center 2xl:w-[750px] xl:w-[550px] bg-green-300">
            ...
            <div className="w-[600px] 2xl:w-[500px] xl:w-[320px] ">
                      ...
                      {({open}) => (
                        <>
                          ...
                          {enabledTwo && (
                            <>
                              <Menu.Items static 
                                className="absolute left-0 z-10 flex flex-col justify-center bg-white border-2 rounded-md h-[10.025rem] focus:outline-none w-44 top-12 dark:border-neutral-500 2xl:w-32 xl:w-20"
                                as={motion.div}
                                initial={{ y: 100}}
                                animate={{ y: 0}}
                                transition={spring}
                                ...
                                <Menu.Item as={motion.div} whileHover={{ scale: 1.1 }} whileTap={{ scale: .9}} transition={spring} >
                                    {({ active }) => (
                                      <MyLink href="#"
                                        className={`${
                                          active ? 'bg-neutral-200 dark:bg-neutral-500' : 'dark:text-black'
                                        } whitespace-nowrap py-3 px-5 flex gap-3 justify-start items-center w-full 2xl:text-md 2xl:text-[.85rem] 2xl:gap-1 2xl:py-0 2xl:px-1  xl:text-[.7rem]`}
                                      >
                                        History
                                      </MyLink>
                                    )}
