            ...
            <div className="w-[70%]">
              ...
              <li className="flex items-center cursor-pointer text-gray-500 font-semibold justify-between w-[20%] hover:text-black transition-all ease-in-out duration-300 relative">
                  <Menu>
                    Features
                    <Menu.Button>
                      <motion.div whileTap={{ rotate: 180 }}><Icon icon="akar-icons:chevron-down" /></motion.div>
                    </Menu.Button>
                    <Menu.Items className="absolute right-16 z-10 bg-white border border-red-100">
                      <Menu.Item><a href="#" className="block px-5 py-3 whites">Todo List</a></Menu.Item>
                      <Menu.Item><a href="#" className="block px-5 py-3 whites">Calendar</a></Menu.Item>
                      <Menu.Item><a href="#" className="block px-5 py-3 whites">Reminders</a></Menu.Item>
                      <Menu.Item><a href="#" className="block px-5 py-3 whites">Planning</a></Menu.Item>
                    </Menu.Items>
                  </Menu>
              </li>
                ...
                <li className="flex items-center cursor-pointer text-gray-500 font-semibold justify-center w-fit hover:text-black transition-all ease-in-out duration-300">Careers</li>
                <li className="flex items-center cursor-pointer text-gray-500 font-semibold justify-center w-fit hover:text-black transition-all ease-in-out duration-300">About</li>
              </ul>
            </div>
        </div>
