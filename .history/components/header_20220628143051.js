...
function Header() {
  ...
  return mounted && (
    <>
      <header className="flex w-full mx-auto justify-between sticky top-0 z-10  bg-neutral-100 h-32 items-center dark:bg-neutral-80">
        <div className="flex w-[950px] justify-around items-center">
            <div className="font-[Arial, Helvetica, sans-serif] text-[4rem] font-bold text-black cursor-default transition-all w-fit duration-150 ease-in-out relative group dark:text-white bg-amber-400">  <svg
            ...
            <div className="w-[600px] 2xl:w-[500px]">
              <ul className="flex justify-between w-full text-xl 2xl:text-[1rem]">
