                    ...
                    {({open}) => (
                      <>
                        ...
                        {enabled && (
                          <>
                            <Menu.Items static 
                              className="absolute left-0 z-10 flex flex-col justify-center bg-white border-2 rounded-md h-[13.5rem] focus:outline-none w-44 top-12 dark:border-neutral-500"
                              as={motion.div}
                              initial={{ y: 100}}
                              animate={{ y: 0}}
                              transition={spring}
                      ...
                      {({open}) => (
                        <>
                          ...
                          {enabledTwo && (
                            <>
                              <Menu.Items static 
                                className="absolute left-0 z-10 flex flex-col justify-center bg-white border-2 rounded-md h-44 focus:outline-none w-44 top-12 dark:border-neutral-500"
                                as={motion.div}
                                initial={{ y: 100}}
                                animate={{ y: 0}}
                                transition={spring}
