    ...
    <>
      <header className="flex max-w-[55%] m-auto justify-between sticky top-0 h-36 items-center">
        ...
        <div>
            ...
            <motion.button className="w-[170px] h-[55px] border border-black rounded-[15px] font-epilogue text-[18px] font-semibold no-underline text-black dark:text-white dark:border-white dark:hover:bg-white dark:hover:text-black transition-all duration-150 ease-out"
