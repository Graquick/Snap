                      ...
                      <>
                        ...
                        <AnimatePresence ExitBeforeEnter>
                            {enabled && (
                              <>
                                <Menu.Items static 
                                  className="absolute left-0 z-10 flex flex-col justify-center bg-white text-black h-fit focus:outline-none w-44 top-12 dark:border-neutral-500 2xl:w-36 2xl:gap-2 xl:-left-4 xl:w-28"
                                  as={motion.div}
                                  initial={{ y: 100}}
                                  animate={{ y: 0}}
                                ...
                                >
                                  <Menu.Item as={motion.div} whileHover={{ scale: 1.1 }} whileTap={{ scale: .9}} transition={spring}>
                                      {({ active }) => (
                                        <MyLink href="#"
                                          ...
                                          } whitespace-nowrap py-3 px-5 flex gap-3 justify-start items-center w-full 2xl:text-[1.1rem] 2xl:h-12 2xl:gap-2 2xl:py-0 2xl:px-4 xl:h-8 xl:text-[.7rem]`}
                                        >
                                  ...
                                  <Menu.Item as={motion.div} whileHover={{ scale: 1.1 }} whileTap={{ scale: .9}} transition={spring}>
                                      {({ active }) => (
                                        ...
                                        >
                                          <Icon icon="uil:calendar-alt" className="text-xl xl:text-md" /> Calendar
                                        </MyLink>
                                      )}
                                  </Menu.Item>
                                  ...
                                  <Menu.Item as={motion.div} whileHover={{ scale: 1.1 }} whileTap={{ scale: .9}} transition={spring}>
                                      {({ active }) => (
                                        ...
                                        >
                                          <Icon icon="uil:lightbulb-alt" className="text-xl xl:text-md" /> Reminders
                                        </MyLink>
                                      )}
                                  </Menu.Item>
                                  ...
                                  <Menu.Item as={motion.div} whileHover={{ scale: 1.1 }} whileTap={{ scale: .9}} transition={spring}>
                                      {({ active }) => (
                                        <MyLink href="#"
                                          className={`${
                                            active ? 'bg-neutral-200 dark:bg-neutral-500' : 'dark:text-black'
                                          } whitespace-nowrap py-3 px-5 flex gap-3 justify-start items-center w-full 2xl:text-[1.1rem] 2xl:h-12 2xl:gap-2 2xl:py-0 2xl:px-4 xl:px-2 xl:h-8 xl:text-[.7rem]`}
                                        >
                                          <Icon icon="uil:clock-three" className="text-xl xl:text-md" /> Planning
                                        </MyLink>
                                      )}
                                  </Menu.Item>
                                </Menu.Items> 
                        ...
                        <>
                          ...
                          <AnimatePresence exitBeforeEnter>
                              {enabledTwo && (
                                  <>
                                      <Menu.Items static 
                                        className="absolute left-0 z-10 flex flex-col justify-center bg-white text-black h-fit focus:outline-none w-44 top-12 dark:border-neutral-500 2xl:w-36  xl:w-20 xl:h-24"
                                        as={motion.div}
                                        initial={{ y: 100}}
                                        animate={{ y: 0}}
                                        exit={{ y: 100, opacity: 0 }}
                                        ...
                                        <Menu.Item as={motion.div} whileHover={{ scale: 1.1 }} whileTap={{ scale: .9}} transition={spring} >
                                            {({ active }) => (
                                              <MyLink href="#"
                                                className={`${
                                                  active ? 'bg-neutral-200 dark:bg-neutral-500' : 'dark:text-black'
                                                } whitespace-nowrap py-3 px-5 flex gap-3 justify-start items-center w-full 2xl:text-[1.1rem] 2xl:h-12 2xl:py-0 2xl:px-4  xl:text-[.7rem]`}
                                              >
                                                History
                                              </MyLink>
                                            )}
