        ...
        <div className="flex w-[45%] justify-between items-center">
            ...
            <div className="w-[70%]">
              <ul className="flex w-full justify-between text-xl">
                ...
                <Menu>
                  <menu.li className="flex items-center cursor-pointer text-gray-500 font-semibold justify-between w-[19%] hover:text-black transition-all ease-in-out duration-300">Features <motion.div
                    whileTap={{ rotate: 180 }}
                  ><menu.iIcon icon="akar-icons:chevron-down" /></motion.div></menu.li>
                </Menu>  
