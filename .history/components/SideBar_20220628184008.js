  ...
  return (
    <>
        <Disclosure as="nav">
            ...
            <div className="p6 w-1/2 h-screen bg-neutral-100 z-20 top-0 -left-96 lg:w-60 lg:left-0 peer-focus:left-0 peer:transition ease-in-out delay-150 duration-200">
