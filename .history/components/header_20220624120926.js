  ...
  return (
    <>
      <header>
          ...
          <div>
            <ul>
              <li className="flex items-center justify-center">Features <Icon icon="akar-icons:chevron-down" /></li>
              <li className="flex items-center justify-center">Company <Icon icon="akar-icons:chevron-down" /></li>
            </ul>
          </div>
