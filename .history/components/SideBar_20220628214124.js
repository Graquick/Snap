                            ...
                            <Menu>
                                ...
                                <>
                                    ...
                                    <>
                                        <AnimatePresence>
                                            <Menu.Items static 
                                            className="flex flex-col justify-center text-black h-[13rem] focus:outline-none w-44 mt-2 bg-green-200 dark:text-white"
                                            as={motion.div}
                                            ...
                                            <Menu.Item as={motion.div} whileHover={{ scale: 1.1 }} whileTap={{ scale: .9}} transition={spring}>
                                                {({ active }) => (
                                                    ...
                                                    } bg-red-500 focus:outline-none ml-8 whitespace-nowrap py-3 px-5 flex gap-3 justify-start items-center w-full`}
                                                    >
