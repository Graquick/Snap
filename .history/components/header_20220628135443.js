        ...
        <div className="flex w-[950px] justify-around items-center">
            ...
            <div className="w-[600px] 2xl:w-[400px]">
              <ul className="flex justify-between w-full text-xl 2xl:text-[1rem]">
                ...
                <li className="flex items-center cursor-pointer text-gray-500 font-semibold justify-between w-[20%] transition-all ease-in-out duration-300 relative dark:text-white 2xl:w-">
                  <Menu>
                    {({open}) => (
                      <>
