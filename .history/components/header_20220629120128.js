        ...
        <div className="flex w-[850px] justify-between items-center 2xl:w-[750px] xl:w-[600px]">
            ...
            <div className="w-[600px] 2xl:w-[500px] xl:w-[360px] lg:hidden ">
              <ul className="flex justify-between w-full text-xl 2xl:text-[1.125rem] xl:text-[.8rem]">
                ...
                <li className="flex items-center cursor-pointer text-gray-500 font-semibold justify-between bg-blue-400 w-[20%] transition-all ease-in-out duration-300 relative dark:text-white 2xl:w-[15%] xl:w-[10%]">
                  <Menu>
                    {({open}) => (
                      <>
