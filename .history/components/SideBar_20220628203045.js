    ...
    <>  
        ...
        <AnimatePresence>
            ...
            <motion.div className="bg-neutral-100/80 backdrop-blur-sm h-[850px] w-[90%] absolute top-0 -right-12  z-10 flex flex-col justify-center items-center text-black dark:bg-neutral-800/80 dark:text-white"
                ...
                exit="closed"
            >
                <ul className="absolute top-32 left-0 flex flex-col gap-8 items-center w-[250px] h-[650px] text-xl">
                            <li className="flex flex-col items-center cursor-pointer text-gray-500 font-semibold justify-between w-[20%] transition-all ease-in-out duration-300 relative dark:text-purple-400 dark:hover:bg-slate-100">
                            <Menu>
                                {({open}) => (
                                <>
                            ...
                            <li className="flex flex-col items-center cursor-pointer text-gray-500 font-semibold justify-between w-[20%]  transition-all ease-in-out duration-300 relative dark:text-purple-400">
                            <Menu>
                                {({open}) => (
                                    <>
                                    ...
                                    {enabledTwo && (
                                        <>
                                        <Menu.Items static 
                                            className="flex flex-col justify-center text-black h-[10rem] mt-2 ml-20 focus:outline-none w-44 top-12 dark:text-white"
                                            as={motion.div}
                                            initial={{ y: 100}}
                                            animate={{ y: 0}}
                                            transition={spring}
                            ...
                            <li className="flex items-center justify-center font-semibold text-gray-500 transition-all duration-300 ease-in-out cursor-pointer w-fit dark:text-purple-400">Careers</li>
                            <li className="flex items-center justify-center font-semibold text-gray-500 transition-all duration-300 ease-in-out cursor-pointer w-fit dark:text-purple-400">About</li>
                </ul>
            </motion.div>
        </AnimatePresence>
    </>
