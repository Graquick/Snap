...
function Header() {
  return (
    <>
      <div className="font-[Arial, Helvetica, sans-serif] text-[4rem] font-bold text-black cursor-default transition-all relative duration-150 ease-in-out relative group dark:text-white">  <svg
