                                ...
                                >
                                  <Menu.Item as={motion.div} whileHover={{ scale: 1.1 }} whileTap={{ scale: .9}} transition={spring}>
                                      {({ active }) => (
                                        ...
                                        >
                                          <Icon icon="uil:clipboard-notes" className="text-xl xl:text-[1]" /> Features
                                        </MyLink>
                                      )}
                                  </Menu.Item>
                                  ...
                                  <Menu.Item as={motion.div} whileHover={{ scale: 1.1 }} whileTap={{ scale: .9}} transition={spring}>
                                      {({ active }) => (
                                        ...
                                        >
                                          <Icon icon="uil:calendar-alt" className="text-xl xl:text-[1]" /> Calendar
                                        </MyLink>
                                      )}
                                  </Menu.Item>
                                  ...
                                  <Menu.Item as={motion.div} whileHover={{ scale: 1.1 }} whileTap={{ scale: .9}} transition={spring}>
                                      {({ active }) => (
                                        ...
                                        >
                                          <Icon icon="uil:clock-three" className="text-xl xl:text-[1]" /> Planning
                                        </MyLink>
                                      )}
                                  </Menu.Item>
                                </Menu.Items> 
