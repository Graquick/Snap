  ...
  return mounted && (
    <>  
        ...
        <AnimatePresence>
            ...
            <motion.div className="bg-neutral-100/80 backdrop-blur-sm h-[850px] w-[90%] absolute top-0 -right-12  z-10 flex flex-col justify-center items-center text-black dark:bg-neutral-800/80 dark:text-yellow-400"
                initial={false}
