            ...
            >
                <ul className="absolute top-32 left-0 flex flex-col gap-8 items-start text-left bg-red-300 w-[250px] h-[650px] text-xl">
                            ...
                            <Menu>
                                {({open}) => (
                                    <>
                                    <Switch checked={enabledTwo} onChange={setEnabledTwo} className={`${enabledTwo ? 'text-purple-400' : 'text-white'} flex items-center justify-sa gap-4`}>
                                    ...
                                    {enabledTwo && (
                                        <>
                                        <Menu.Items static 
                                            className="flex flex-col justify-center bg-fuchsia-200 text-black h-[10rem] mt-2 focus:outline-none w-44 dark:text-white"
                                            as={motion.div}
                                            initial={{ y: 100}}
                                            animate={{ y: 0}}
                                            transition={spring}
