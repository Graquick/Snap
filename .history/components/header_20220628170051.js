    ...
    <>
      <header className="flex w-full mx-auto justify-between sticky top-0 z-10  bg-neutral-100 h-28 items-center dark:bg-neutral-80">
        <div className="flex w-[850px] justify-between items-center 2xl:w-[750px] xl:w-[600px]">
            <div className="font-[Arial, Helvetica, sans-serif] text-[4rem] font-bold text-black cursor-default transition-all w-fit duration-150 ease-in-out relative group dark:text-white lg:text-[3rem]">  <svg
              className="absolute top-[2.5rem] -right-8 w-[26px] h-[26px] transition-all duration-500 ease-in-out lg:top-[2.25rem]"
              width={26}
              height={24}
              viewBox="0 0 26 24"
              fill="none"
