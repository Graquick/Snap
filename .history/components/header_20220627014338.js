                  ...
                  <Menu>
                    {({open}) => (
                      <>
                        ...
                        {open && (
                          <>
                            <Menu.Items static className={`${open ? 'hidden' :'block dark:border-neutral-500 border rounded-md'}`}
                              styles={{ position: "absolute", top: "3rem", left: 0, zIndex: 10, width: "11rem", height: "14rem", background: "white"  }}
