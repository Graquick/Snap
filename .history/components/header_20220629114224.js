                      ...
                      <>
                        ...
                        <AnimatePresence ExitBeforeEnter>
                            {enabled && (
                              <>
                                <Menu.Items static 
                                  className="absolute left-0 z-10 flex flex-col justify-center bg-white text-black h-fit focus:outline-none w-44 top-12 dark:border-neutral-500 2xl:w-36 2xl:gap-2 xl:w-28"
                                  as={motion.div}
                                  initial={{ y: 100}}
                                  animate={{ y: 0}}
                      ...
                      {({open}) => (
                        <>
                          <Switch checked={enabledTwo} onChange={setEnabledTwo} className="flex items-center justify-center gap-2">
                            Company <Icon icon="akar-icons:chevron-down"  className={`${enabledTwo ? 'rotate-180' : 'rotate-0'} transition-all duration-150 ease-in-out xl:relative xl:left-4`}/>
                          </Switch>
                          <AnimatePresence exitBeforeEnter>
                              {enabledTwo && (
                                  <>
