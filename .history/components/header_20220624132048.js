        ...
        <div className="flex w-[45%] justify-between items-center">
            ...
            <div className="w-[70%]">
              <ul className="flex w-full justify-between text-xl">
                <li className="flex items-center cursor-pointer text-gray-500 font-normal justify-between w-[17%]"
                  whileHover={{  }}
                >Features <motion.div
                  whileTap={{ rotate: 180 }}
                ><Icon icon="akar-icons:chevron-down" /></motion.div></li>
                <li className="flex items-center cursor-pointer text-gray-500 font-normal justify-between w-[19%]"
                  whileHover={{  }}
                >Company <motion.div
                  whileTap={{ rotate: 180 }}
                ><Icon icon="akar-icons:chevron-down" /></motion.div></li>
                <li className="flex items-center cursor-pointer text-gray-500 font-normal justify-center w-fit"
                  whileHover ={{ }}
                >Careers</li>
                <li className="flex items-center cursor-pointer text-gray-500 font-normal justify-center w-fit"
                  whileHov er={{ }}
