  ...
  return mounted && (
    <>  
        ...
        <AnimatePresence>
            ...
            <motion.div className="bg-neutral-100/90 backdrop-blur-md h-[850px] w-[90%] absolute top-0 -right-12  z-10 flex flex-col justify-center items-center text-black dark:bg-neutral-800/90 dark:text-white"
                initial={false}
