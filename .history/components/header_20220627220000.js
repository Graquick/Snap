...
function Header() {
  ...
  return mounted && (
    <>
      <header className="flex max-w-[1600px] w-[95%] m-auto justify-between sticky top-0 h-36 items-center 2xl:w-[375px] 2xl:max-w-[375px] 2xl:block bg-red-600 2xl:h-16">
