      ...
      <header>
          ...
          <div>
            <ul>
              ...
              <li className="flex items-center justify-center w-fit">Careers <Icon icon="akar-icons:chevron-down" /></li>
              <li className="flex items-center justify-center w-fit">About <Icon icon="akar-icons:chevron-down" /></li>
            </ul>
          </div>
