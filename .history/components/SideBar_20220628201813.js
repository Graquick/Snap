    ...
    <>  
        ...
        <AnimatePresence>
            ...
            <motion.div className="bg-neutral-100/80 backdrop-blur-sm h-[850px] w-[90%] absolute top-0 -right-12  z-10 flex flex-col justify-center items-center text-black dark:bg-neutral-800/80 dark:text-white"
                ...
                exit="closed"
            >
                <ul className="absolute top-32 left-0 flex flex-col gap-8 items-center w-[250px] h-[650px] text-2xl">
                            ...
                            <Menu>
                                ...
                                <>
                                    ...
                                    <>
                                        <Menu.Items static 
                                        className="flex flex-col justify-center bg-neutral-100 h-[15rem] focus:outline-none w-52 mt-8 dark:border-neutral-500"
                                        as={motion.div}
                                        initial={{ y: 100}}
                                        animate={{ y: 0}}
                                        transition={spring}
                                        ...
                                        <Menu.Item as={motion.div} whileHover={{ scale: 1.1 }} whileTap={{ scale: .9}} transition={spring}>
                                            {({ active }) => (
                                                ...
                                                >
                                                <Icon icon="uil:clipboard-notes" className="text-2xl" /> Features
                                                </MyLink>
                                            )}
                                        </Menu.Item>
