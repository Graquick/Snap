...
function Header() {
  ...
  return mounted && (
    <>
      <header className="flex w-full mx-auto justify-between sticky top-0 z-10  bg-neutral-100 h-32 items-center dark:bg-neutral-80 2xl:bg-red-300">
        <div className="flex w-[950px] justify-around items-center">
            ...
            <div className="w-[600px] bg-blue-500 2xl:w-[400px]">
              <ul className="flex justify-between w-full text-xl 2xl:text-sm">
