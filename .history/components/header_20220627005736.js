        ...
        <div className="flex w-[45%] justify-between items-center">
            ...
            <div className="w-[70%]">
              <ul className="flex justify-between w-full text-xl">
                  ...
                  <Menu>
                    {({open}) => (
                      <>
                        ...
                        {open && (
                          <>
                            <Menu.Items className="absolute left-0 z-10 w-40 bg-white border rounded-md top-12 h-44">
                              <Menu.Item>
                                  {({ active }) => (
                                    <MyLink href="#"
                                      className={`${
                                      ...
                                      style={{ whiteSpace: "nowrap", padding: " .75rem 1.25rem", display: "flex", gap: ".75rem", justifyContent: "center", alignItems: "center"  }}
                                    >
                ...
                <li className="flex items-center cursor-pointer text-gray-500 font-semibold justify-between w-[20%]  transition-all ease-in-out duration-300">Company <motion.div
                  
                ><Icon icon="akar-icons:chevron-down" /></motion.div></li>


                <li className="flex items-center justify-center font-semibold text-gray-500 transition-all duration-300 ease-in-out cursor-pointer w-fit">Careers</li>
                <li className="flex items-center justify-center font-semibold text-gray-500 transition-all duration-300 ease-in-out cursor-pointer w-fit ">About</li>
              </ul>
            </div>
        </div>
