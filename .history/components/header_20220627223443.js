    ...
    <>
      <header className="flex max-w-[1600px] w-[95%] m-auto justify-between sticky top-0 h-36 items-center 2xl:w-[375px] 2xl:block 2xl:h-16">
        ...
        <div className="2xl:hidden">
            <motion.div className="w-[170px] h-[55px] font-epilogue text-[18px] font-semibold no-underline text-black dark:text-white"
                whileTap={{ x: 0, scale: 0.5 }}
              >
                Login
              </motion.div>

            <motion.div className="w-[170px] h-[55px] border border-black rounded-[15px] font-epilogue text-[18px] font-semibold no-underline text-black hover:bg-black hover:text-white dark:text-white dark:border-white dark:hover:bg-white dark:hover:text-black transition-all duration-150 ease-out"
                whileTap={{ x: 0, scale: 0.5 }}
              >
                Register
              </motion.div>
