        ...
        <div className="flex w-[45%] justify-between items-center">
            ...
            <div className="w-[70%]">
              <ul className="flex justify-between w-full text-xl">
                    ...
                    {({open}) => (
                      <>
                        ...
                        {enabled && (
                          <>
                            <Menu.Items static 
                              className="absolute left-0 z-10 h-56 bg-white border-2 rounded-md focus:outline-none w-44 top-12 dark:border-neutral-500"
                              as={motion.div}
                              initial={{ y: 100}}
                              animate={{ y: 0}}
                              transition={spring}
                ...
                <li className="flex items-center cursor-pointer text-gray-500 font-semibold justify-between w-[20%]  transition-all ease-in-out duration-300 dark:text-white">
                  <Menu>
                      {({open}) => (
                        <>
                          <Menu.Button>
                          <Switch checked={enabledTwo} onChange={setEnabled} className="flex items-center justify-center gap-4">
                            Company <Icon icon="akar-icons:chevron-down"  className={`${enabled ? 'rotate-180' : 'rotate-0'} transition-all duration-150 ease-in-out`}/>
                          </Switch> 
                          </Menu.Button>
                          {enabled && (
                            <>
