    ...
    <>
      <header className="flex max-w-[80%] m-auto bg-red-100 justify-between sticky top-0">
        <div className="flex w-[45%] bg-red-400 justify-between items-center">
            ...
            <div>
              <ul className="flex w-[600px] bg-fuchsia-200 justify-between text-xl">
                <li className="flex items-center justify-between w-[20%]">Features <motion.div
                  whileTap={{ rotate: 180 }}
                ><Icon icon="akar-icons:chevron-down" /></motion.div></li>
                <li className="flex items-center justify-between w-[20%]">Company <motion.div
                  whileTap={{ rotate: 180 }}
                ><Icon icon="akar-icons:chevron-down" /></motion.div></li>
