                      ...
                      <>
                        ...
                        <AnimatePresence ExitBeforeEnter>
                            {enabled && (
                              <>
                                <Menu.Items static 
                                  className="absolute left-0 z-10 flex flex-col justify-center bg-white text-black h-fit focus:outline-none w-44 top-12 dark:border-neutral-500 2xl:w-36 2xl:gap-2 xl:top-[2.5rem] xl:-left-[1.25rem] xl:w-32"
                                  as={motion.div}
                                  initial={{ y: 100}}
                                  animate={{ y: 0}}
