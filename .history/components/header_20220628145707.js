...
function Header() {
  ...
  return mounted && (
    <>
      <header className="flex w-full mx-auto justify-between sticky top-0 z-10  bg-neutral-100 h-32 items-center dark:bg-neutral-80 bg-amber-400">
        <div className="flex w-[850px] justify-between items-center 2xl:w-[750px] xl:w-[550px]">
            ...
            <div className="w-[600px] 2xl:w-[500px] xl:w-[300px] ">
                    ...
                    {({open}) => (
                      <>
                        ...
                        {enabled && (
                          <>
                            <Menu.Items static 
                              className="absolute left-0 z-10 flex flex-col justify-center bg-white border-2 rounded-md h-[13.25rem] focus:outline-none w-44 top-12 dark:border-neutral-500 2xl:w-32 xl:w-20"
                              as={motion.div}
                              initial={{ y: 100}}
                              animate={{ y: 0}}
                              transition={spring}
                            ...
                            >
                              <Menu.Item as={motion.div} whileHover={{ scale: 1.1 }} whileTap={{ scale: .9}} transition={spring}>
                                  {({ active }) => (
                                    <MyLink href="#"
                                      ...
                                      } whitespace-nowrap py-3 px-5 flex gap-3 justify-start items-center w-full 2xl:text-[.85rem] 2xl:gap-1 2xl:p-0 2xl:justify-center xl:text-[.7rem]`}
                                    >
                              ...
                              <Menu.Item as={motion.div} whileHover={{ scale: 1.1 }} whileTap={{ scale: .9}} transition={spring}>
                                  {({ active }) => (
                                    ...
                                    >
                                      <Icon icon="uil:calendar-alt" className="text-xl" /> Calendar
                                    </MyLink>
                                  )}
                              </Menu.Item>
                              ...
                              <Menu.Item as={motion.div} whileHover={{ scale: 1.1 }} whileTap={{ scale: .9}} transition={spring}>
                                  {({ active }) => (
                                    <MyLink href="#"
                                      className={`${
                                        active ? 'bg-neutral-200 dark:bg-neutral-500' : 'dark:text-black'
                                      } whitespace-nowrap py-3 px-5 flex gap-3 justify-start items-center w-full 2xl:text-[.85rem]`}
                                    >
                                      <Icon icon="uil:lightbulb-alt" className="text-xl" /> Reminders
                                    </MyLink>
                                  )}
                              </Menu.Item>
                              ...
                              <Menu.Item as={motion.div} whileHover={{ scale: 1.1 }} whileTap={{ scale: .9}} transition={spring}>
                                  {({ active }) => (
                                    ...
                                    >
                                      <Icon icon="uil:clock-three" className="text-xl" /> Planning
                                    </MyLink>
                                  )}
                              </Menu.Item>
                            </Menu.Items> 
                      ...
                      {({open}) => (
                        <>
                          <Switch checked={enabledTwo} onChange={setEnabledTwo} className="flex items-center justify-center gap-2">
                            Company <Icon icon="akar-icons:chevron-down"  className={`${enabledTwo ? 'rotate-180' : 'rotate-0'} transition-all duration-150 ease-in-out 2xl:text-sm`}/>
                          </Switch>
                          {enabledTwo && (
                            <>
                              <Menu.Items static 
                                className="absolute left-0 z-10 flex flex-col justify-center bg-white border-2 rounded-md h-[10.025rem] focus:outline-none w-44 top-12 dark:border-neutral-500 2xl:w-32"
                                as={motion.div}
                                initial={{ y: 100}}
                                animate={{ y: 0}}
                                transition={spring}
                                ...
                                <Menu.Item as={motion.div} whileHover={{ scale: 1.1 }} whileTap={{ scale: .9}} transition={spring} >
                                    {({ active }) => (
                                      <MyLink href="#"
                                        className={`${
                                          active ? 'bg-neutral-200 dark:bg-neutral-500' : 'dark:text-black'
                                        } whitespace-nowrap py-3 px-5 flex gap-3 justify-start items-center w-full 2xl:text-md`}
                                      >
                                        History
                                      </MyLink>
                                    )}
