        ...
        <div className="flex w-[45%] justify-between items-center">
            ...
            <div className="w-[70%]">
              ...
              <li className="flex items-center cursor-pointer text-gray-500 font-semibold justify-between w-[20%] hover:text-black transition-all ease-in-out duration-300 relative">
                    <Menu>
                      <Menu.Button>Todo List</Menu.Button>
                      <Menu.Items>
                        <Menu.Item className="absolute top-0 left-0 z-10 w-24 bg-white border">
                          <MyLink href="#" className="flex px-5 py-3 text-blue-400 whitespace-nowrap"> <Icon icon="uil:clipboard-notes" className="mr-4" /> Profile</MyLink>
                        </Menu.Item>
                      </Menu.Items>
                    </Menu>
              </li>
