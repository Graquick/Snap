        ...
        <div className="flex w-[45%] bg-red-400 justify-between items-center">
            ...
            <div>
              <ul className="flex w-[600px] bg-fuchsia-200 justify-between">
                <li className="flex items-center justify-between w-[15%]">Features <Icon icon="akar-icons:chevron-down" /></li>
                <li className="flex items-center justify-between w-[16%]">Company <motion className="div"></motion> <Icon icon="akar-icons:chevron-down" /></li>
