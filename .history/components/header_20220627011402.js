                  ...
                  <Menu>
                    {({open}) => (
                      <>
                        ...
                        {open && (
                          <>
                            <Menu.Items className="absolute left-0 z-10 w-40 h-56 bg-white border rounded-md top-12 dark:border-neutral-500" static>
                              <Menu.Item>
                                  {({ active }) => (
                                    <MyLink href="#"
                                      className={`${
                              ...
                              <Menu.Item>
                                  {({ active }) => (
                                    <MyLink href="#"
                                      ...
                                      style={{ whiteSpace: "nowrap", padding: " .75rem 1.25rem", display: "flex", gap: ".75rem", justifyContent: "center", alignItems: "center"  }}
                                    >
                                      <Icon icon="uil:clipboard-notes" /> Calendar
                                    </MyLink>
                                  )}
                              </Menu.Item>
